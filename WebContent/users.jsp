    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">账户表</h1>
                ...
                <ul class="breadcrumb">
            <li><a href="Stuff.jsp">主页</a> <span class="divider">/</span></li>
...
<div class="well">
 ...
 <td height="22" align="center" width="100px"><a href="admin_user.jsp"><div width="100px">修改密码</div></a></td>
    ...
    <script type="text/javascript">
        ...
        function transfer() {
    		...
    		if(pageSize!=null||pageSize!="")
    		   window.location.href="http://localhost:8080/Logistics-system/allservlet?pageNo="+pageSize;
    		alert("即将跳转")//可以获取到该值
    	}
    </script>
