...
<meta charset="utf-8">
  ...
  <body class=""> 
    ...
    <div class="content">
		...
		<%
			String td_id = request.getParameter("vehicle_id");
			String pageNo = request.getParameter("pageNo");
		%>
    
    	<div class="container-fluid">
    		<div class="row-fluid">
    		<form method="get" action="http://localhost:8080/Logistics-system/update_dingdan_servlet">
    			<div class="btn-toolbar" style="margin-left: 25px;">    
    				<a href="admin_update_dingdan.jsp?td_id=<%=td_id%>" class="btn">重置</a>
    					...
    					<table class="table list">
    						<tbody id="prolist">
    							...
    							<tr>
									<td>
										<p>
											<input type="text" value=<%=td_id%> class="input-small" name="td_id">
										</p>
									</td>
    								<td>
    									<p>
